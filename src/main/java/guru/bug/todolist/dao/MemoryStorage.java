...
public class MemoryStorage implements Storage {
    ...
    public void init() {
        this.data.addAll(List.of(
                new ToDoItem(nextId(), State.DONE, "Cras ut neque", false, false, (LocalDate) null, "Sed ut enim suscipit, iaculis ante a, luctus dui. In hac habitasse platea dictumst."),
                new ToDoItem(nextId(), State.BACKLOG, "Vivamus mattis", false, false, (LocalDate) null, "mi nec efficitur eleifend, mauris neque efficitur nibh, sit amet suscipit risus ligula sit amet ex. Fusce eu magna sed lacus gravida ultricies."),
                ...
                new ToDoItem(nextId(), State.TODO, "Morbi pellentesque felis sit amet", true, false, (LocalDate) null, "Nam sollicitudin tristique quam. Sed tristique velit et hendrerit tincidunt. Morbi sed velit libero."),
                ...
                new ToDoItem(nextId(), State.DELETED, "Mauris ac ullamcorper", false, false, (LocalDate) null, "Quisque accumsan quam nec purus sagittis, a vestibulum mi consectetur."),
                ...
                new ToDoItem(nextId(), State.TODO, "Nam sollicitudin euismod", false, false, (LocalDate) null, "Mauris ac ullamcorper nisi. Nulla facilisi."),
